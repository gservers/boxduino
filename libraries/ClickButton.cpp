...
#include "Prescaler.h" //Provides fixes for timing functions after playing with PWM frequency
...
{
  long now = (long)trueMillis();      // get current time
  //changed to trueMillis() due to changing PWM frequency
